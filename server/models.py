...
class TileState(IntEnum):
	HIDDEN = 1
	SHOWN = 2
	EXPLOSION = 3 # this might not need a dedicated state (SHOWN + MINE = explosion)
	FLAG = 4
...
class World(models.Model):
	...
	state = models.IntegerField(choices=WorldState.choices(), default=WorldState.LOADING)
...
class Tile(models.Model):
	...
	state = models.IntegerField(choices=TileState.choices(), default=TileState.HIDDEN)
